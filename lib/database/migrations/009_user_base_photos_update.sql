-- Update user_base_photos table for base photo management
-- Migration: 009_user_base_photos_update
-- Description: Updates user_base_photos table to support base photo upload and management
