...
export class ClothingDetectionService {
  ...
  async analyzeClothingImage(
    ...
    try {
      ...
      const detectionResult = this.parseAnalysisResult(
        analysisResult,
        userCategory
      );
      ...
      return {
        ...
        suggestions: [],
        warnings: [
          'AI analysis failed. Please verify your selection manually.',
        ],
  ...
  getClothingSuggestions(
    attributes: ClothingDetectionResult['detectedAttributes']
  ): string[] {
  ...
  private parseAnalysisResult(
    ...
    try {
      ...
      const suggestedCategory =
        detectedCategory !== userCategory ? detectedCategory : null;
